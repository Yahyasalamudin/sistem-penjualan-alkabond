...
class TransactionExport implements FromCollection, WithHeadings, WithMapping, WithColumnWidths, WithStyles
{
    protected $transactions, $start_date, $end_date;

    public function __construct($transactions, $start_date, $end_date)
    {
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        return [
            ...
            'C' => ['alignment' => ['horizontal' => Alignment::HORIZONTAL_CENTER]], // Nama Toko
            'D' => ['alignment' => ['horizontal' => Alignment::HORIZONTAL_CENTER]], // Nama Sales
            'E' => ['alignment' => ['horizontal' => Alignment::HORIZONTAL_CENTER]], // Metode Pembayaran
            'F' => ['alignment' => ['horizontal' => Alignment::HORIZONTAL_CENTER]], // Status Pembayaran
            'G' => ['alignment' => ['horizontal' => Alignment::HORIZONTAL_CENTER]], // Status Pengiriman
            'H' => ['alignment' => ['horizontal' => Alignment::HORIZONTAL_CENTER]], // Tanggal Transaksi
